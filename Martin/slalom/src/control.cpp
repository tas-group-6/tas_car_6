...
void control::odomCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
    ...
    //Angular and Linear Velocity to a steering angle
    odom_steeringAngle = 180 / M_PI*atan(odom_angularVelocity/odom_linearVelocity*CAR_LENGTH);

    //Put into right range
...
void control::cmdCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
    ...
    cmd_steeringAngle = 180/M_PI*atan(cmd_angularVelocity/cmd_linearVelocity*CAR_LENGTH);
